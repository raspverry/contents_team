...
20명의 AI 에이전트가 콘텐츠를 생산하는 1인 회사 운영 시스템.

인스타그램 릴스, 스레드, 카드뉴스, 팬딩 멤버십 콘텐츠를 AI 에이전트 팀이 기획부터 제작까지 자동으로 처리합니다.
...
| **카드뉴스 제작팀** | 리서처, 레이아웃 디자이너, 메이커, 템플릿 디자이너, 테마 디자이너 | 카드뉴스 기획/제작 |
...
| `cardnews-pipeline` | 카드뉴스 파이프라인 | 리서치 → 레이아웃 → 렌더링 지시서 |
